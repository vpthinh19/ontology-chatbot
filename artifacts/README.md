...
|---|---|---|---|
| `figures/` | Nguồn của mọi hình trong tài liệu: bảy sơ đồ Graphviz và bộ dựng biểu đồ | có | - |
...
`figures/` là **mã nguồn**: bảy tệp `.dot` và các script dựng biểu đồ. Ảnh chúng
