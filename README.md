...
Ontology là nơi giữ nội dung có thẩm quyền. Dataset hiện có **6.239 câu**, gồm
5.451 câu huấn luyện, 399 câu kiểm định và 389 câu kiểm tra. Danh mục khả năng
...
| Tập | Số câu | Vai trò |
|---|---:|---|
| Huấn luyện | 5.451 | Kho ví dụ cho ánh xạ câu hỏi sang shape truy xuất |
| Kiểm định | 399 | Kiểm tra lựa chọn/cấu hình mà không dùng tập kiểm tra |
| Kiểm tra | 389 | Đánh giá cuối sau khi cấu hình đã cố định |
| **Tổng** | **6.239** | Tổng số dòng thực tế trong ba tệp |
