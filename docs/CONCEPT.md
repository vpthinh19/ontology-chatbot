...
Hình 4 minh hoạ trường hợp đi nhiều bước ứng với Dạng 3 ở Mục 4.2, trong đó các nút lồng nhau là một đường đi theo quan hệ.
...
để tránh phê phán rằng phép đối chứng dùng baseline yếu. Cụm baseline là một module độc lập (`src/ontchatbot/baseline/`), được phép
dùng GPU khi đánh giá, và không nằm trong bản triển khai CPU của hệ ontology.
