...
Ba tệp JSONL chứa **5.088 câu**:

| Tệp | Số dòng dữ liệu |
|---|---:|
| `resources/dataset/train.jsonl` | 4.299 |
...
tổng `dataset.records = 5088` và cùng số bản ghi theo split. Đây là thống kê
...
`reports/dataset.json` ghi phân bố của 5.088 dòng hiện có:
