...
R = json.loads((HERE / "ket-qua.json").read_text())
KHUON = build_instructions()

sys.path.insert(0, str(HERE))
from chay import khong_bam_du_lieu  # dùng lại đúng phép trích số/viết tắt
...
(HERE / "ket-qua-cham-lai.json").write_text(json.dumps(R, ensure_ascii=False, indent=1))
